...
import { addLesson } from '../util/APIUtils';
...
class Container extends Component {
    ...
    constructor(){
       ...
       this.state={
        title: null,course:null, showList:false, show:true,
        description:"",
       }
    }
    ...
    save(){
        if (this.state.title != null){
            addLesson(this.state.course.id,this.state.title,this.state.description).then(
    ...
    render(){
      return(
        ...
        <Modal.Header closeButton>
          <Modal.Title>Додання уроку до курсу</Modal.Title>
         <Form.Group>
          </Form.Group>
        </Modal.Header>
        <Modal.Body>
